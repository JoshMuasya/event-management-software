...
export default function DashboardHome() {
  ...
  if (!event) {
    return (
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12">
        ...
        <h2 className="relative text-3xl font-playfair text-[#6A0DAD] text-center">
          Event not found
        </h2>
      </div>
    );
  ...
  const eventLinks = [
    {
      name: 'Invitations',
      href: `/rsvp-management/events/${eventId}/invitations`,
      desc: 'Design and manage event invitations',
    },
    {
      name: 'Guest List',
      href: `/rsvp-management/events/${eventId}/guest-list`,
      desc: 'Manage your event guests',
    },
    {
      name: 'Check-In',
      href: `/rsvp-management/events/${eventId}/check-in`,
      desc: 'Handle guest check-ins',
    },
    {
      name: 'Reports',
      href: `/rsvp-management/events/${eventId}/reports`,
      desc: 'View event reports and analytics',
    },
    {
      name: 'Thank You Notes',
      href: `/rsvp-management/events/${eventId}/thank-you`,
      desc: 'Send post-event thank you messages',
    },
  ];
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12">
      ...
      >
        Welcome to the {event.name} Management Dashboard
      </h2>
